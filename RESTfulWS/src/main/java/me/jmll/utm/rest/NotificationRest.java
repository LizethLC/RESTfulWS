...
public class NotificationRest {
	...
	@RequestMapping(value = "notify", method = RequestMethod.GET, produces = { "application/json", "text/json" })
	@ResponseBody
	...
	@RequestMapping(value = "notify", method = RequestMethod.GET, produces = { "application/xml", "text/xml" })
	@ResponseBody
	@ResponseStatus(HttpStatus.OK)
